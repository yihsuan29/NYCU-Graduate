...
class SACAgent:
    ...
    def update_model(self) -> Tuple[torch.Tensor, ...]:
        ...
        v_target = torch.min(q1_new,q2_new) - alpha* log_prob_new
        v = self.vf(state)
        ...
        if self.total_step % self.policy_update_freq == 0:
            ...
            ########## Your Code (<5 lines)##########
            advantage = q1_new - v.detach()
            actor_loss = (alpha * log_prob_new - advantage).mean()
    ...
    def test(self, video_folder: str, seed: int):
        ...
        #print("score: ", score)
        print("Seed:",seed," EWMA: ", ewma_reward)
        self.env.close()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-dir", type=str, default="task1/model/", help="Directory where the model is saved.")
    parser.add_argument("--video-dir", type=str, default="task1/videos/", help="Directory to save the test video.")
    parser.add_argument("--txt-dir", type=str, default="task1", help="Directory to save test seed")    
